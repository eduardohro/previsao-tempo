document.querySelector('#search').addEventListener('submit', async(event) => {
    ...
    const apiKey = 'd4f4fc3fbcb000350ff5fed520e45011';
    ...
    if (json.cod === 200) {
        ...
        showAlert(`
            ...
            <img src="src/images/undraw_to-the-moon_w1wa.svg">
        `)
    }
});
...
function showInfo(json) {
    ...
    document.querySelector('#temp_img').setAttribute('src', `https://openweather.org/img/wn/${json.tempIcon}@2x.png`);
